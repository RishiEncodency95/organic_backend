...
import fs from "fs";
const router = Router();
import * as ctrl from "./beyondExhibition.controller";
...
router.get('/', (req, res) => ctrl.getBeyondExhibition(req, res));

const uploadFields = [
    { name: 'image', maxCount: 1 }
];

router.post('/', upload.fields(uploadFields), (req, res) => ctrl.updateBeyondExhibition(req, res));
