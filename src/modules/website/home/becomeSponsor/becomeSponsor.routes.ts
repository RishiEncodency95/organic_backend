...
import fs from "fs";
const router = Router();
import * as ctrl from "./becomeSponsor.controller";
...
router.get('/', (req, res) => ctrl.getBecomeSponsor(req, res));

const uploadFields = [
    { name: 'image', maxCount: 1 }
];

router.post('/', upload.fields(uploadFields), (req, res) => ctrl.updateBecomeSponsor(req, res));
