...
import fs from "fs";
const router = Router();
import * as ctrl from "./conferenceSeminars.controller";
...
router.get('/', (req, res) => ctrl.getConferenceSeminars(req, res));

const uploadFields = [
    { name: 'image', maxCount: 1 }
];

router.post('/', upload.fields(uploadFields), (req, res) => ctrl.updateConferenceSeminars(req, res));
