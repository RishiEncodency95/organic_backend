...
import fs from "fs";
const router = Router();
import * as ctrl from "./whyParticipate.controller";
...
router.get('/', (req, res) => ctrl.getWhyParticipate(req, res));
...
router.post('/', upload.fields(uploadFields), (req, res) => ctrl.updateWhyParticipate(req, res));
