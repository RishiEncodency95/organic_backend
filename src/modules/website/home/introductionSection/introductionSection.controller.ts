...
import IntroductionSection from './introductionSection.model';


    export const getIntroduction = async (req: Request | any, res: Response | any) => {
        try {
    ...
    export const updateIntroduction = async (req: Request | any, res: Response | any) => {
        try {
